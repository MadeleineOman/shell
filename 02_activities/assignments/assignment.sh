...
cp data/raw/rawdata/server_log_* data/processed/server_logs/

# 6. Repeat the above step for user logs and event logs
cp data/raw/rawdata/user_* data/processed/user_logs/
cp data/raw/rawdata/event_log_* data/processed/event_logs/
